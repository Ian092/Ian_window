...
btn1=tk.Button(window,text="+",width=10,bg="pink",command=click1)
btn1.grid(row=0,column=1)

btn2=tk.Button(window,text="-",width=10,bg="pink",command=click2)
btn2.grid(row=1,column=1)

btn3=tk.Button(window,text="*",width=10,bg="pink",command=click3)
btn3.grid(row=2,column=1)

btn4=tk.Button(window,text="/",width=10,bg="pink",command=click4)
